...
export const LIB: LibraryData = {
  ...
  controls: [
    ...
    {name:"Text Input", tags:["form","field","input"], example:'Add a text input labeled "Legal Name" with placeholder and validation.', visual:"📝"},
    {name:"Text Area", tags:["form","field","multiline"], example:'Add a text area labeled "Comments" for long-form text.', visual:"📄"},
    ...
    {name:"Tooltip", tags:["help","hover","hint"], example:'Add a tooltip with helpful text that appears on hover.', visual:"💬"},
    {name:"Menu", tags:["dropdown","navigation","actions"], example:'Add a menu dropdown with action items.', visual:"☰"},
    {name:"Pagination", tags:["navigation","pages","list"], example:'Add pagination controls for navigating through pages of data.', visual:"⏪"},
    {name:"Color Picker", tags:["color","picker","input"], example:'Add a color picker for selecting brand colors.', visual:"🎨"},
    {name:"Segmented Control", tags:["toggle","choice","tabs"], example:'Add segmented control for "View Mode" options.', visual:"▬"},
    {name:"Table", tags:["data","rows"], example:'Add a table of direct reports with columns Name, Title, Location.', visual:"📊"},
    {name:"Layout", tags:["grid","flex","container"], example:'Create a 2-column grid layout for organizing content.', visual:"⚏"},
